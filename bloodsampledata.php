...
$query_Recordset1 = "SELECT * FROM users where type='مريض'";
...
<div class="col-sm-9">
	<div class="panel panel-success">
		<div class="panel-heading">
		<h3 class="panel-title"> تسجيل العينات</h3>
		</div>
		<div class="panel-body">
...
<select name="PatientID">  <?php do { ?>
        <option value="<?php echo $row_Recordset1['ID_NO']; ?>"><?php echo $row_Recordset1['FName']; ?></option>
       
<?php } while ($row_Recordset1 = mysql_fetch_assoc($Recordset1)); ?> </select>

 </div>
        <div class="form-group">
    	<label for="Name">اسم العينة أو التحليل</label>
		...
		<select name="Type">
		<option>صوردة دم كاملة - Whole Blood</option>
		<option>مصل - Serum</option>
		<option>بلازما - Plasma</option>
		</select>
		</div>
		<div class="form-group">
		<label for="PTT">زمن تخثر الدم PTT</label>
		<span id="sprytextfield2">
		<input type="text" class="form-control" id="PTT" name="PTT">
		<span class="textfieldInvalidFormatMsg">خطأ.</span></span></div>
	<div class="form-group">
		<label for="Hemoglobin">عدد الهيموجلوبين Hemoglobin</label>
		<span id="sprytextfield3">
        <input type="text" class="form-control" id="Hemoglobin" name="Hemoglobin">
<span class="textfieldInvalidFormatMsg">خطأ.</span></span></div>
		<div class="form-group">
		<label for="Hematocrit">نسبة ترسب خلايا الدم الحمراء Hematocrit</label>
		<span id="sprytextfield4">
        <input type="text" class="form-control" id="Hematocrit" name="Hematocrit">
<span class="textfieldInvalidFormatMsg">خطأ.</span></span></div>
		<div class="form-group">
		<label for="MCV">متوسط حجم الخلايا الحمراء MCV</label>
		<span id="sprytextfield5">
        <input type="text" class="form-control" id="MCV" name="MCV">
<span class="textfieldInvalidFormatMsg">خطأ.</span></span></div>
<div class="form-group">
		<label for="BMP">معدل السكر في الدم  BMP</label>
		<span id="sprytextfield7">
        <input type="text" class="form-control" id="BMP" name="BMP">
<span class="textfieldInvalidFormatMsg">خطأ.</span></span></div>
		<div class="form-group">
		<label for="Glucose">الجلوكوز Glucose</label>
		<span id="sprytextfield8">
        <input type="text" class="form-control" id="Glucose" name="Glucose">
<span class="textfieldInvalidFormatMsg">خطأ.</span></span></div>
	<div class="form-group">
		<label for="Calcium">الكالسيوم Calcium</label>
...
$Notes=$_POST['Notes'];
mysql_select_db($database_db_con, $db_con);
$sql=mysql_query("insert into blood_samples  values(null ,'$PatientID','$fname','$Type','$PTT','$Hemoglobin','$Hematocrit','$MCV','$BMP','$Glucose','$Calcium','$sdate','$Notes')") or die(mysql_error());
$mmessage ="شكراً لك لتواصلك معنا .";
...
var sprytextfield5 = new Spry.Widget.ValidationTextField("sprytextfield5", "integer", {isRequired:false, validateOn:["blur", "change"]});
var sprytextfield6 = new Spry.Widget.ValidationTextField("sprytextfield6", "integer", {isRequired:false, validateOn:["blur", "change"]});
var sprytextfield7 = new Spry.Widget.ValidationTextField("sprytextfield7", "integer", {isRequired:false, validateOn:["blur", "change"]});
var sprytextfield8 = new Spry.Widget.ValidationTextField("sprytextfield8", "integer", {isRequired:false, validateOn:["blur", "change"]});
var sprytextfield9 = new Spry.Widget.ValidationTextField("sprytextfield9", "integer", {isRequired:false, validateOn:["blur", "change"]});
  </script>
</body>
</html>
<?php
