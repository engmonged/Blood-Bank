...
$query_rst_contact = "SELECT * FROM contactus";
$rst_contact = mysql_query($query_rst_contact, $db_con) or die(mysql_error());
$row_rst_contact = mysql_fetch_assoc($rst_contact);
$totalRows_rst_contact = mysql_num_rows($rst_contact);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="col-sm-9">
	<div class="panel panel-danger">
		<div class="panel-heading">
			<h3 class="panel-title"> اتصل بنا</h3>
		</div>
		<div class="panel-body">
		...
		<div class="form-group">
            ...
            <span class="textfieldRequiredMsg">مطلوب.</span><span class="textfieldInvalidFormatMsg">الصيغة خطأ.</span></span></div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<span class="textareaRequiredMsg">مطلوب.</span></span></div>
		
		<button type="submit" class="btn btn-danger">اتصل</button>
...
mysql_select_db($database_db_con, $db_con);
$sql=mysql_query("insert into contactus values(null ,'$fname','$umobile','$uemail','$umessage')") or die(mysql_error());
