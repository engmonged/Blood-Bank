...
$query_Recordset1 = "SELECT * FROM blood_types";
...
<div class="col-sm-9">
	<div class="panel panel-danger">
		<div class="panel-heading">
			<h3 class="panel-title"> فصائل الدم</h3>
		</div>
		<div class="panel-body">
		...
		<div class="form-group">
			<label for="Type">المضاد</label>
			<span id="sprytextfield2">
			<input type="text" class="form-control" id="Type" name="Type">
			<span class="textfieldRequiredMsg">مطلوب.</span></span></div>
		<div class="form-group">
			<label for="RH">عامل ريسسز RH</label>
			<select name="RH">
			<option value="1">موجب</option>
			<option value="0">سالب</option>
</select>
			</div>
		<div class="form-group">
...
$Notes=$_POST['Notes'];
mysql_select_db($database_db_con, $db_con);
$sql=mysql_query("insert into blood_types values(null ,'$fname','$Type','$RH','$Notes')") or die(mysql_error());
$mmessage ="شكراً لك.";
