...
$query_Recordset1 = "SELECT * FROM diseases";
...
<div class="col-sm-9">
	<div class="panel panel-danger">
		<div class="panel-heading">
			<h3 class="panel-title"> الأمراض المتوطنة</h3>
		</div>
		<div class="panel-body">
		...
		<div class="form-group">
			<label for="Mobile">متوطن في</label>
<select name="Endemic_country[]" multiple  class="form-control">
  <option>مصر</option>
  ...
  <p>استمر بالضغط على  مفتاح ctrl للاختيار المتعدد .</p>
          </div>
		<div class="form-group">
			<label for="effect">الأثر الطبي</label>
		...
		<div class="form-group">
			<label for="Inquire">يصيب</label>
		<select name="Inquire[]" multiple  class="form-control">
  ...
  <p>استمر بالضغط على  مفتاح ctrl للاختيار المتعدد .</p>
				...
				<div class="form-group">
			<label for="Information">عضو الجسم</label>
		
			<select name="Part_Body[]" multiple  class="form-control">
  <option>الرأس</option>
  <option>القلب</option>
  <option>الرئتين</option>
  <option>المريء</option>
   <option>الكبد</option>
  </select>
...
{
$fname=$_POST['Name'];
$Endemic_country=$_POST['Endemic_country'];
$vecd=implode(",",$Endemic_country);
$effect=$_POST['effect'];
$Treatment=$_POST['Treatment'];
$Information=$_POST['Information'];
$Inquire =$_POST['Inquire'];
$vinq=implode(",",$Inquire);
$Part_Body=$_POST['Part_Body'];
$PB=implode(",",$Part_Body);
$notes =$_POST['notes'];
mysql_select_db($database_db_con, $db_con);
$sql=mysql_query("insert into diseases values(null ,'$fname','$vecd','$effect','$Treatment','$Information','$vinq','$PB','$notes')") or die(mysql_error());
$mmessage ="شكراً لك  .";
